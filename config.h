...
// 1 = Ativa depuração via monitor serial (diagnóstico), 0 = Desativa para máxima economia de Flash
...
following deadzone.
*/
#define DEADZONE 10 // Recommended to have this as small as possible to allow full range of motion.
...
#define SENS_TX 0.8
#define SENS_TY 1
#define SENS_PTZ 2 // sensitivity for positive translation z
#define SENS_NTZ 1 // sensitivity for negative translation z
#define GATE_NTZ 25 // gate value, which negative z movements will be ignored (like an additional deadzone for -z).
...
#define MOD_B                                                                                      \
  1.35 // factor "b",   recommended: 1.0 ... 1.57 [tan(0..1) up to tan(0..pi/2)] -> bigger value
...
#define COMP_WAIT 100 // [ms] time to wait and monitor before compensating (smaller value=>faster re-centering, but may cut off small moves)
